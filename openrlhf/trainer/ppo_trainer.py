...
class PPOTrainer(ABC):
    ...
    def __init__(
        ...
        **generate_kwargs,
        ...
        self.replay_buffer = NaiveReplayBuffer(micro_train_batch_size, buffer_limit, buffer_cpu_offload, Re_sampling=True)
    ...
    def evaluate(self):
        for rand_prompts in self.eval_dataloader:
            experience = self.experience_maker.make_experience(rand_prompts, mode="eval", **self.generate_kwargs)
