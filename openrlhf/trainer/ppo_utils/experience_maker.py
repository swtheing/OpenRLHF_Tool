...
class NaiveExperienceMaker(ABC):
    ...
    @torch.no_grad()
    def make_experience(self, prompts: Union[str, List[str]], mode, **generate_kwargs) -> Experience:
        self.actor.eval()
        self.critic.eval()
        ...
        #print("batch_decode:")
        #print(self.tokenizer.batch_decode(token_ids_cpu))
        #print(prompts)
        ...
        # rewards
        r = self.reward_model(sequences, attention_mask, mode=mode)
